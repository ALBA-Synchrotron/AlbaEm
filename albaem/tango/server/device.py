...
# ------------------------------------------------------------------
    ...
    def init_device(self):
        ...
        try:
            ...
            if self.LogFileName != "" or self.LogFileName is None or self.LogFileName == []:
                ...
                handler = logging.handlers.RotatingFileHandler(
                    self.LogFileName, maxBytes=10240000, backupCount=5)
...
# ------------------------------------------------------------------
    def read_Firmware_version(self, attr):
        ...
        #    Add your own code here
        try:
            firmware = self.AlbaElectr.extractSimple(
                self.AlbaElectr.ask('?FIM'))
